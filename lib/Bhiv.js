...
module.exports = new function Bhiv() {
  ...
  this.VM = new function () {
    ...
    this.Runtime.prototype.each = function (ast, data, callback) {
      ...
      return this.run(ast.source, data, function (err, source) {
        if (err) return callback(err);
        return Bhiv.Async.each(source, function (item, callback, index) {
          var payload = {};
  ...
  this.Node.prototype.begin = function (payload) {
    ...
    return new Bhiv.VM.AST.Waterfall(null, function (data, callback) {
      if (hasPayload) {
  ...
  this.Node.prototype.on = function (name, ast) {
    ...
    case 1:
      ...
      return new Bhiv.VM.AST.Waterfall(null, function () {
        error = null;
