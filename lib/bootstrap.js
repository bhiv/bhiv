...
(function YoloBootstrap() {
  ...
  Bhiv.process = function (pattern, sources) {
    ...
    case 'jp': return jp.search(sources[0], pattern.substr(3));
    default: return pattern;
    }
  };
  Yolo.Node.prototype.resolve.query = function (str, data, callback) {
    switch (str.substr(0, str.indexOf(':'))) {
    case 'jp': return callback(null, jp.search(data, str.substr(3)));
    default: return callback(null, str);
    }
  };
