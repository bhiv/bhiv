...
module.exports = new function Yolo() {
  ...
  this.VM = new function () {
    ...
    this.AST = new function () {
      ...
      this._Action.prototype._push = function (ast) {
        this._current = ast;
        return this;
      };

      this._Action.prototype.relocate = function (location) {};

      this._Action.prototype.format = function (glue) {
        return this._push(glue);
      };

      this._Action.prototype.then = function (identifier, glue) {
        var ast = { $: identifier };
        if (arguments.length > 1) ast._ = glue;
        this._push(ast);
        return new AST._Merger(this);
      };

      this._Action.prototype.apply = function () {};

      /** Control Flow */

      this._Action.prototype.Race = function () {};

      this._Action.prototype.Until = function () {};

      /** Collection Iterator */

      this._Action.prototype.Fold = function () {};

      this._Action.prototype.Map = function () {};

      this._Action.prototype.Filter = function () {};

      this._Action.prototype.Detect = function () {};

      /** Conditions */

      this._Action.prototype.Match = function () {};

      this._Action.prototype.Unless = function () {};

      /** Flow Exception */

      this._Action.prototype.memoize = function (duration, key) {};

      this._Action.prototype.shunt = function (predicate, glue) {};

      this._Action.prototype.trap = function (pattern, glue) {};

      /* Merger */
      this._Merger = function (self) {
        this._parent  = self._parent;
        this._current = self._current;
        this._ast     = self._ast;
        if (self.hasOwnProperty('end'))
          this.end = self.end;
      };

      this._Merger.prototype = new this._Action();
      ...
      this._Waterfall.prototype = new this._Action();
      ...
      this._Waterfall.prototype.end = function () {
        debugger;
        return this._parent(this._ast);
      };
