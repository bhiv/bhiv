...
module.exports = new function Yolo() {
  ...
  this.VM = new function () {
    ...
    this.AST = new function () {
      ...
      this._Waterfall.prototype.trap = function (pattern, glue) {};
    ...
    // Collections
    this.Runtime.prototype.map = function (ast, data, callback) {
      var runtime = this;
    ...
    // TODO: sanitize this pattern according .Map one
    ...
    this.Runtime.prototype.match = function (ast, data, callback) {
      ...
      if (!('match' in ast)) {
        ...
        return this._match_find(param, data, callback);
      }
      var runtime = this;
      return this.run(ast.match, data, function (err, view) {
        if (err) return callback(err);
        var param = { view: view, cases: list, otherwise: ast.otherwise };
        return runtime._match_find(param, data, callback);
      });
    };

    this.Runtime.prototype._match_find = function (ast, flow, callback) {
      var runtime = this;
      var FOUND = {};
