...
module.exports = new function Yolo() {
  ...
  this.Util = new function () {
    ...
    this.getIn = function (source, path) {
      ...
      if (Yolo.Util.kind(source) === 'Object') {
    ...
    this.setIn = function (target, path, value) {
      ...
      while (chain.length > 0) {
        ...
        } else if (target.hasOwnProperty(chain[0]) && Yolo.Util.kind(target[chain[0]]) === 'Object') {
  ...
  this.VM = new function () {
    ...
    this.AST = new function () {
      ...
      this._Race.prototype.At = function (path) {
  ...
  this.Node.prototype.register = function () {
    if (arguments.length == 1) {
      if (Yolo.Util.kind(arguments[0]) === 'Object') {
      ...
      if (Yolo.Util.kind(structure) === 'Object') {
      ...
      if (node.layout == null) {
        ...
        Yolo.Util.walk2(node.data, scope[node.layout].data, function (chain, left, right) {
          ...
          while (chain.length > 0) {
            ...
            } else if (Yolo.Util.kind(target[chain[0]]) === 'Object') {
              target = target[chain.shift()];
            } else {
              target = target[chain.shift()] = {};
            }
  ...
  this.Node.prototype.set = function (path, value) {
    ...
    while (chain.length > 0) {
      ...
      } else if (Yolo.Util.kind(data[chain[0]]) === 'Object') {
  ...
  this.Node.prototype.field = function (name, fqn, options) {
    if (this.kind() != 'Record') throw new Error(this.cwd() + ': This node is not a Record');
    if (Yolo.Util.kind(options) !== 'Object') options = { name: name, fqn: fqn, required: !!options };
  ...
  this.Node.prototype.attach = function (child, name) {
    ...
    if (older != null) {
      ...
      throw new Error('Child with the same name "' + name + '" already attached');
    }
    child.name = name;
    child.parent = this;
