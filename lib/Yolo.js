...
module.exports = new function Yolo() {
  ...
  this.Node.Method.prototype.call = function (stage, payload, flux) {
    if (typeof this.ast == 'function') {
      var context = { node: stage.node, super: this._super, stage: stage };
      ...
      return stage.node.resolve(ast, payload, flux);
    }
  };

  this.Node.Method.prototype._super = function (payload, callback) {
    debugger;
  };
  ...
  this.Stage.prototype.run = function (payload, flux) {
    var node = this.root, method = null;
    while (node != null) {
