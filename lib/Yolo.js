...
module.exports = new function Yolo() {
  ...
  this.VM = new function () {
    ...
    this.AST = new function () {
      ...
      this.Waterfall.prototype.$Waterfall = function (parent, end) {
        var waterfall = new AST.Waterfall(parent, end);
      ...
      this.Waterfall.prototype.load = function (filepath, prefix) {
      ...
      this.Waterfall.prototype.apply = function (path, identifier) {
        assert.isPath(path);
        assert.isIdentifier(identifier);
