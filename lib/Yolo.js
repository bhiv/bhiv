...
module.exports = new function Yolo() {
  ...
  this.VM = new function () {
    ...
    this.AST = new function () {
      ...
      this._Waterfall.prototype.$Waterfall = function (parent, end) {
        var waterfall = new AST._Waterfall(parent, end);
        waterfall.$syntaxes = this.$syntaxes.slice();
        for (var i = 0; i < this.$syntaxes.length; i++) {
          var syntax = this.$syntaxes[i];
      ...
      this._Waterfall.prototype.$push = function (ast) {
        this.$current = ast;
        if (this.$ast === NULL)
          this.$ast = ast;
      ...
      this._Waterfall.prototype.$merger = function () {
      ...
      this._Waterfall.prototype.load = function (filepath, prefix) {
        ...
        this.$syntaxes.push({ prefix: prefix, module: module });
        return this.$Waterfall(this, function () {
      ...
      this._Race.prototype.$isConflict = function (path) {
        var pattern = path + '.';
      ...
      this._Match.prototype.$bind = function (waterfall) {
      ...
      this._MetaCall.prototype.$Waterfall = function (action, selector, glue) {
      ...
      this._MetaCall.prototype.Append = function (selector, glue) {
        ...
        return this.$Waterfall.apply(this, args);
      };
