...
module.exports = new function Yolo() {
  ...
  this.VM = new function () {
    ...
    this.AST = new function () {
      ...
      this.Block.prototype._push = function (ast) {
      ...
      this.Waterfall.prototype.format = function (glue) {
        return this._push(glue);
      };

      this.Waterfall.prototype.then = function (fqn, glue, options) {
        
      };

      this.Waterfall.prototype.race = function () {
        return new this.Race(function (ast) {
          
        });
      };

      this.Waterfall.prototype.Race = function (parent, end) {
        this._ast    = null;
        this._parent = parent;
        if (end) this.end = end;
      };
      ...
      this.Waterfall.prototype.map = function () {
        return new this.Waterfall(function (ast) {
      ...
      this.Waterfall.prototype.Match = function (end) {
        this._ast    = null;
        this._parent = parent;
        if (end) this.end = end;
      };
      ...
      this.Waterfall.prototype.Match.prototype.when = function () {
        return new this.Waterfall(this);
      };
    ...
    this.Context = function (stage) {
      this.stage = stage;
      this.node = stage.root;
    };

    this.Context.prototype.super = function (payload, callback) {
      return this.stage.run(payload, callback);
    };

    this.Context.prototype.next = function (callback) {
      var self = this;
    ...
    this.Runtime.prototype.route = function (ast, payload, callback) {
      switch (Object.prototype.toString.call(ast)) {
      default :
        return callback(null, payload);
      case '[object Object]':
        if ('$_' in ast) this.interrupt(ast.$_, data);
      ...
      case '[object Array]':
        return this.mapArray(ast, payload, callback);
      case '[object String]':
    ...
    this.Runtime.prototype.execute = function (ast, data, callback) {
      ...
      if (typeof ast.$ == 'string') return this.node.send(ast.$, data, callback);
    ...
    this.Runtime.prototype.call = function (ast, payload, callback) {
      switch (this.ast.length) {
      case 0: case 1:
        try { var result = ast.call(this, payload); }
        catch (error) { return callback(error); }
        return callback(null, result);
      case 2:
        return ast.call(this, payload, callback);
      default:
    ...
    this.Runtime.prototype.translate = function (ast, data, callback) {
      return this.execute(ast, data, callback);
    };
    ...
    this.Runtime.prototype.mapObject = function (object, data, callback) {
      ...
      return Yolo.Async.each(Yolo.Util.keysOf(object), function (key, callback) {
        var work = object[key];
        return runtime.route(work, data, function (err, value) {
    ...
    this.Runtime.prototype.mapArray = function (list, data, callback) {
      var runtime = this;
      return Yolo.Async.map(list, function (schema, callback) {
        return runtime.route(schema, data, function (err, value) {
    ...
    this.Runtime.prototype.waterfall = function (workflow, data, callback) {
      ...
      return Yolo.Async.fold(workflow, data, function (ast, accumulator, callback) {
        return runtime.route(ast, accumulator, callback);
      }, callback);
    };
    ...
    this.Runtime.prototype.match = function (ast, data, callback) {
      var runtime = this;
      return this.route(ast.match, data, function (err, result) {
        if (err) return callback(err);
        ...
        return Yolo.Async.fold(patterns, null, function (pattern, success, callback) {
          ...
          if (err) return callback(err);
          if (pattern == null) return runtime.route(ast.otherwise, data, callback);
          return runtime.route(ast.cases[pattern], data, callback);
        });
      });
    };
    ...
    this.Runtime.prototype.unless = function (prefetch, data, callback) {
      var runtime = this;
      return this.route(prefetch.unless, data, function (err, result) {
        if (err) return callback(err);
        if (result) return callback(null, data);
        return runtime.route(prefetch.proceed, data, callback);
      });
    };

    this.Runtime.prototype.error = function (ast, data, callback) {
      return this.route(ast, data, function (err, payload) {
        if (err) return callback(err);
    ...
    this.Runtime.prototype.memoize = function (rule, data, callback) {
      ...
      if (memo == null) this.node.set('__memoize', memo = new Cache(rule.expire));
      return this.route(key, data, function (err, key) {
        if (err) return callback(err);
        ...
        if (work != null) {
          ...
          return runtime.route(rule.then, data, function (err, value) {
      ...
      for (var i = 0; i < ast.length; i++)
        callback = (function (runtime, method, payload, callback) {
          return function (error, result) {
            ...
            return runtime[ast.type](ast, data, callback);
          };
        })(runtime, ast[i], payload, callback);
      return callback;
    };
    ...
    this.Runtime.prototype.merge = function (ast, data, callback) {
      ...
      switch (ast.mode) {
      case 'wrap':
        return this.route(ast.glue, data, callback);
      case 'root':
    ...
    this.Runtime.prototype.trap = function (ast, data, callback) {
      ...
      if (ast.trap_if == null) return this.route(ast.trap, data, callback);
      var runtime = this;
      return this.route(ast.trap_if.match, data, function (err, result) {
        if (err) return callback(err);
        var pattern = ast.trap_if.pattern;
        if (pattern instanceof RegExp) {
          if (pattern.test(result))
            return runtime.route(ast.trap, data, callback);
        } else {
          debugger;
  ...
  this.Node.prototype._inlet = function (event, slice) {
    ...
    var flux  = Yolo.Flux.create(event.handler);
 ...
 /**************************/
  ...
  this.Flux = new function () {
    ...
    this.create = function (stage, handler) {
      ...
      flux.emit    = _emit;
      flux.has     = _has;
      flux.handler = new Yolo.Handler(handler);
      return flux;
    };
  ...
  this.Stage.prototype.run = function (payload, callback) {
    ...
    while (this.next != null) {
      ast = this.next.inlets[this.name];
      this.next = this.next.older;
      if (ast == null) continue ;
      return new Yolo.VM.Runtime(this).route(ast, payload, callback);
    }
    return callback(null, payload);
  };
