...
module.exports = new function Yolo() {
  ...
  this.Method.context.super = function (payload, callback) {
    debugger;
  };

  this.Method.context.next = function (callback) {
    var self = this;
    return function (err, result) {
      if (err) return callback(err);
  ...
  this.Method.prototype.call = function (stage, payload, flux) {
    if (typeof this.ast == 'function') {
      var context = Object.create(Yolo.Method.context);
      context.stage = stage;
      context.node = stage.root;
      ...
      return stage.current.resolve(this.ast, payload, flux);
    }
  };
