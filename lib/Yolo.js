...
module.exports = new function Yolo() {
  ...
  this.VM = new function () {
    ...
    this.AST = new function () {
      ...
      /* Relocate */
      this._Option.prototype.relocate = function (location) {};

      /* Format */
      this._Option.prototype.format = function (glue) {};

      /* Then */
      this._Option.prototype.then = function (identifier, glue) {};

      this._Merger = function () {};

      this._Merger.prototype = new this._Option();
      ...
      this._Option.prototype.apply = function () {};
