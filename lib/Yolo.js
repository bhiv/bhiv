...
module.exports = new function Yolo() {
  ...
  this.Node.prototype.identity = function (name, fields) {
    ...
    this.model.identities[name] = fields;
    return this;
  };
  ...
  this.Node.prototype.field = function (name, fqn, options) {
    ...
    if (options.unique && this.model.identities[name] == null)
      this.model.identities[name] = [name];
    return this;
  };
  ...
  this.Flux = new function () {
    ...
    this.create = function (node, inlet, handler, track) {
      ...
      flux.toString = Yolo.Flux._toString;
    ...
    this._toString = function () { return '[object YoloFlux]'; };
