...
module.exports = new function Yolo() {
  ...
  this.Node.prototype.resolve = function (schema, data, callback) {
    ...
    case '[object Function]':
      return callback(new Error('Resolving function is disabled because it can not be serialized'));
    default :
  ...
  this.Node.prototype.resolve.dollar = function (action, data, callback) {
    ...
    if ('_' in action) {
      ...
      return this.resolve.waterfall.call(this, action.$, data, then);
  ...
  this.Node.prototype.resolve.memoize = function (rule, data, callback) {
    var node = this;
