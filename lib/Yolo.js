...
module.exports = new function Yolo() {
  ...
  this.VM = new function () {
    ...
    this.AST = new function () {
      ...
      this._Waterfall.prototype.Block = function (tags) {
        if (typeof tags == 'string') tags = tags.split(/[\s\n]+/);
        return new AST._Waterfall(this, function () {
          var ast = { $: { type: 'block', tags: tags, block: this._ast } };
          return this._parent._push(ast);
        });
      };
      ...
      this._MetaCall = function () {

      };

      this._MetaCall.prototype.At = function () {

      };

      this._MetaCallPosition = function () {

      };

      this._MetaCallPosition.prototype.ingest = function () {

      };

      this._MetaCallPosition.prototype.Do = function () {
    ...
    this.Runtime.prototype.block = function (ast, data, callback) {
      return this.run(ast.block, data, callback);
    };
