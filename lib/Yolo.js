...
module.exports = new function Yolo() {
  ...
  this.debug = false;
  this.noop = function () {};
  this.create = function () { return new Yolo.Node('SideLess', 'Root'); };
  ...
  this.Cache.prototype.gc = function () {
    ...
    for (var i = 0; i < discard.length; i++) {
      ...
      while ((discard[i].queue || []).length > 0) {
        var err = new Error('Yolo.Cache: untrottle call garbage collected');
