...
module.exports = new function Yolo() {
  ...
  this.Procedure = function () {
    this.AST = { root: null, current:  };
  };

  this.Procedure.clone = function () {
     
  };

  this.Procedure.end = function () {
    return this.AST.root;
  };

  this.Procedure.goto = function () {};

  this.Procedure.get = function () {};
  this.Procedure.then = function () {};
  this.Procedure.change = function () {};

  this.Procedure.map = function () {};
  this.Procedure.fold = function () {};
  this.Procedure.filter = function () {};
  this.Procedure.detect = function () {};

  this.Procedure.match = function () {};
  this.Procedure.Match = {};
  this.Procedure.Match.when = function () {};
  this.Procedure.Match.otherwise = function () {};
  this.Procedure.Match.end = function () {};

  this.Procedure.trap = function () {};
  this.Procedure.redirect = function () {};
  this.Procedure.unless = function () {};
  this.Procedure.lazy = function () {};
  this.Procedure.retry = function () {};
  ...
  this.Node.prototype.resolve.dollar = function (action, data, callback) {
    ...
    if ('_' in action) {
      ...
      return Yolo.Async.fold(action.$, data, function (action, accumulator, callback) {
