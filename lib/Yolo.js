...
module.exports = new function Yolo() {
  ...
  this.Util = new function () {
    ...
    this.serialize = function serialize(data, skipempty, iterator) {
      ...
      case '[object Object]':
        if (data.constructor !== Object && data.constructor.toString)
          return data.toString();
        if (data._yolo_serialize != null) return data._yolo_serialize;
  ...
  this.VM = new function () {
    ...
    this.AST = new function () {
      ...
      var pipeOf = function (identifier, glue) {
        var ast = { $: identifier };
        if (arguments.length < 2) return ast;
        ast._ = glue;
        return ast;
      };
      ...
      this._Waterfall.prototype.shunt = function (test, identifier, glue) {
        var then = pipeOf.apply(this, Array.prototype.slice.call(arguments, 1));
        return new AST._Waterfall(this, function () {
      ...
      this._Waterfall.prototype.trap = function (test, identifier, glue) {
        var then = pipeOf.apply(this, Array.prototype.slice.call(arguments, 1));
        return new AST._Waterfall(this, function () {
      ...
      this._Waterfall.prototype.assert = function (test, identifier, glue) {
        var then = pipeOf.apply(this, Array.prototype.slice.call(arguments, 1));
        return new AST._Waterfall(this, function () {
          var ast = { $: { type: 'assert', test: test, then: then, block: this._ast } };
          var context = this._parent._push(ast);
          return context.end.apply(context, arguments);
        });
      };

      this._Waterfall.prototype.failWith = function (error) {
        var ast = { $: { type: 'assert', test: false, glue: error } };
        return this._push(ast);
      };
    ...
    this.Runtime.prototype.execute = function (ast, data, callback) {
      ...
      if (typeof ast.$ == 'string') return this.resolve(ast, data, callback);
  ...
  this.Node.prototype.begin = function (payload) {
    ...
    return new Yolo.VM.AST._Waterfall(null, function (callback) {
      if (arguments.length < 1) throw new Error('Should be call for now');
