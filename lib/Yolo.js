...
module.exports = new function Yolo() {
  ...
  this.VM = new function () {
    ...
    this.AST = new function () {
      ...
      this._Waterfall.prototype.Until = function (test, glue) {
        var hasGlue = arguments.length > 1;
        return new AST._Waterfall(this, function () {
          var ast = { $: { type: 'until', test: test, block: this._ast } };
      ...
      this._Waterfall.prototype.shunt = function (test, glue) {
        return new AST._Waterfall(this, function () {
          var ast = { $: { type: 'shunt', test: test, glue: glue, block: this._ast } };
          var context = this._parent._push(ast);
          return context.end.apply(context, arguments);
        });
      };

      this._Waterfall.prototype.trap = function (test, glue) {
        return new AST._Waterfall(this, function () {
          var ast = { $: { type: 'trap', test: test, glue: glue, block: this._ast } };
          var context = this._parent._push(ast);
          return context.end.apply(context, arguments);
        });
      };

      this._Waterfall.prototype.assert = function (pattern, glue) {
        return new AST._Waterfall(this, function () {
          var ast = { $: { type: 'assert', test: test, glue: glue, block: this._ast } };
          var context = this._parent._push(ast);
          return context.end.apply(context, arguments);
        });
      };
        ...
        return runtime.run(ast.test, payload, function (err, result) {
          ...
          return runtime[format](ast.glue, payload, function (err, data) {
            ...
            return runtime.run(ast.block, data, function (err, flow) {
              if (err) return callback(err);
              return loop(runtime, ast, flow, times + 1, callback);
            });
          });
        });
    ...
    this.Runtime.prototype.shunt = function (ast, data, callback) {
      ...
      return runtime.run(ast.test, data, function (err, result) {
        if (err) return callback(err);
        if (result) {
          if (!('glue' in ast)) return callback(null, data);
          return runtime.run(ast.glue, data, callback);
        } else {
          return runtime.run(ast.block, data, callback);
        }
      });
